...
export function FiberFactsShowcase({ product }: FiberFactsShowcaseProps) {
  return (
    <section className="relative bg-accent py-16 sm:py-28 lg:py-40 overflow-hidden">
      ...
      <div className="relative px-5 sm:px-8 lg:px-20">
        <div className="mx-auto max-w-[1280px]">
          <div className="flex flex-col items-center text-center lg:flex-row lg:items-center lg:text-left lg:gap-24">
            ...
            <div className="flex-1 order-2 lg:order-1 mt-10 sm:mt-12 lg:mt-0">
              <p className="font-body text-[12px] sm:text-[13px] font-medium uppercase tracking-[0.08em] text-background/50">
                Fiber Facts
              </p>
              <h2 className="mt-3 sm:mt-4 font-display text-[34px] sm:text-[40px] lg:text-[48px] font-bold leading-[1.05] tracking-[-0.025em] text-background">
                Every thread,
                <br />
                accounted for.
              </h2>
              ...
              <div className="mt-6 sm:mt-8 flex justify-center lg:justify-start gap-5 sm:gap-6">
                <div className="flex items-center gap-2">
                  <span className="h-2.5 w-2.5 rounded-full bg-natural" />
                  <span className="font-body text-[13px] sm:text-[14px] text-background/75">
                    100% Natural
                  </span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className="group/arrow mt-7 sm:mt-8 inline-flex items-center justify-center rounded-full bg-background px-7 py-3 font-body text-[14px] font-semibold text-text transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/10 active:translate-y-0 active:shadow-md"
              >
                See it in action{" "}
            ...
            <div className="order-1 lg:order-2 w-full max-w-[340px] sm:max-w-[420px] lg:flex-shrink-0 transform lg:rotate-[-2deg] transition-transform duration-500 ease-out hover:rotate-0 hover:scale-[1.02]">
