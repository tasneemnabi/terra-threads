-- Extract the shared product filter logic into a reusable function.
-- Both filter_products and get_available_brands were duplicating ~30 lines
-- of identical WHERE-clause logic. This function returns matching product IDs.

CREATE OR REPLACE FUNCTION filtered_product_ids(
...
-- Recreate filter_products using the shared filter function
...
-- Recreate get_available_brands using the shared filter function
